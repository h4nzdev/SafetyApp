  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className={`${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'} p-6 rounded-2xl border shadow-sm`}>
          <div className="flex items-center justify-between">
            <div>
              <p className={`${isDarkMode ? 'text-slate-300' : 'text-slate-500'} text-sm font-medium`}>
                Active Incidents
              </p>
        ...
        <div className={`${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'} p-6 rounded-2xl border shadow-sm`}>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>2</p>
            </div>
            <div className="bg-red-100 w-12 h-12 rounded-xl flex items-center justify-center">
        ...
        <div className={`${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'} p-6 rounded-2xl border shadow-sm`}>
          <div className="flex items-center justify-between">
            ...
            <div className={`${isDarkMode ? 'bg-slate-700' : 'bg-slate-100'} w-12 h-12 rounded-xl flex items-center justify-center`}>
      ...
      <div className={`${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'} border rounded-2xl p-6 shadow-sm`}>
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-3">
            <button className={`flex items-center space-x-2 px-4 py-2 ${isDarkMode ? 'bg-slate-700 hover:bg-slate-600 text-slate-200' : 'bg-slate-100 hover:bg-slate-200 text-slate-700'} rounded-xl transition-colors duration-200`}>
        ...
        <div className="relative h-96 rounded-2xl overflow-hidden">
          {/* Severity Legend */}
          <div className={`absolute top-6 right-6 z-[1000] ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'} p-6 rounded-2xl shadow-lg border`}>
            <h4 className={`font-bold ${isDarkMode ? 'text-white' : 'text-slate-800'} mb-4`}>Severity Legend</h4>
      ...
      <div className={`${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-200'} border rounded-2xl p-6 shadow-sm`}>
        <div className="flex items-center justify-between mb-6">
          <h3 className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>Recent Incidents</h3>
          <div className="flex space-x-3">
            ...
            <button className={`px-4 py-2 ${isDarkMode ? 'bg-slate-700 text-slate-200' : 'bg-slate-100 text-slate-700'} rounded-xl text-sm font-medium ${isDarkMode ? 'hover:bg-slate-600' : 'hover:bg-slate-200'} transition-colors`}>
              High Priority
            </button>
            <button className={`px-4 py-2 ${isDarkMode ? 'bg-slate-700 text-slate-200' : 'bg-slate-100 text-slate-700'} rounded-xl text-sm font-medium ${isDarkMode ? 'hover:bg-slate-600' : 'hover:bg-slate-200'} transition-colors`}>
              Last 24h
