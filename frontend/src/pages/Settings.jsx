      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-slate-50 rounded-xl">
            <p className="text-lg font-bold text-slate-800">v2.1.4</p>
            <p className="text-slate-500 text-sm mt-1">App Version</p>
          </div>

          <div className="text-center p-4 bg-slate-50 rounded-xl">
            <p className="text-lg font-bold text-slate-800">Updated</p>
            <p className="text-slate-500 text-sm mt-1">Aug 15, 2025</p>
          </div>
