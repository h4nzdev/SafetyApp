    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button
            onClick={handleCall}
            className="bg-white p-4 flex flex-col items-center rounded-xl border border-slate-200 hover:border-red-300 hover:shadow-md transition-all duration-200 group"
          >
            ...
            <span className="text-sm font-semibold text-slate-700">Call 911</span>
          </button>
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-slate-800">{activeReport}</p>
            </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          <div className="bg-white border-l-4 border-yellow-500 rounded-xl shadow-sm">
            <div className="p-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-semibold text-slate-800">Flood Warning</h3>
          ...
          <div className="bg-white border-l-4 border-red-500 rounded-xl shadow-sm">
            <div className="p-4">
              <div className="flex items-start space-x-3">
      ...
      <div>
        <h2 className="text-2xl font-bold text-slate-800 mb-6">Recent Incidents</h2>
        ...
        {reports.length === 0 ? (
          ...
          <div className="space-y-3">
            {reports.map((report) => (
              <div key={report.id} className="bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-200">
                <div className="p-4">
                  ...
                  <p className="text-slate-600 mb-3 text-sm bg-slate-50 p-3 rounded-lg">
                    {report.description}
                  </p>
