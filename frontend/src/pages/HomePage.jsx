import { Phone, FileText, MapPin, Users, AlertTriangle, TrendingUp, Clock, Map } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-8 text-white">
        <h1 className="text-3xl font-bold mb-2">Welcome back, Hanz!</h1>
        <p className="text-red-100 text-lg">Stay informed about emergency situations in your area</p>
      </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-xl border border-slate-200 hover:shadow-md transition-shadow">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <h3 className="font-semibold text-slate-800 mb-2">Traffic Accident</h3>
                <p className="text-slate-600 text-sm mb-3">
                  Two-vehicle collision at intersection requiring emergency response.
                </p>
                <div className="flex items-center text-xs text-slate-500">
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 hover:shadow-md transition-shadow">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <h3 className="font-semibold text-slate-800 mb-2">Fire Incident</h3>
                <p className="text-slate-600 text-sm mb-3">
